...
import { UsersField } from "@/app/lib/definitions";
import Link from "next/link";
import { LockClosedIcon, UserCircleIcon, EnvelopeIcon, ClockIcon, CheckIcon } from "@heroicons/react/24/outline";
import { Button } from "@/app/ui/button";
import { createUser } from "@/app/lib/actions";
import { useFormState } from "react-dom";
import toast from "react-hot-toast";

export default function Form({ user }: { user: UsersField[] }) {
